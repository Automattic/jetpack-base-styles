...
### Fixed
- Admin page layout: Clip the wp-build stage so content outside the scrolling area cannot add a second scrollbar.
...
[1.2.14-alpha]: https://github.com/Automattic/jetpack-base-styles/compare/1.2.13...1.2.14-alpha
